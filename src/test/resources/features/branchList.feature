...
Feature: Verify admin can register and edit a branch
  ...
  Background:
    ...
    Scenario Outline: admin should be able to register branch with mandatory fields successfully
      ...
      |Pret A MANGER|randomData |eastham@gmail.com|eastham|43, rudland, eastham|17.45|16.17|London|4564567564|
      |Pret A MANGER|randomData  |ilford@gmail.com |ilford |43, rudland, ilford |17.45|16.17|London|4564567564|
